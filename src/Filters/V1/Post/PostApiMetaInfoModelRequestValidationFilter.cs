...
/// 
/// </summary>
public class PostApiMetaInfoModelRequestValidationFilter : 
    PostRequestValidationFilter<PostApiMetaInfoModelRequest>
{
	/// <summary>
	/// SUMMARY NEEDED HERE
	/// </summary>
	public const string ModelsKey = "PostModelsModelRequest";

	/// <summary>
	/// SUMMARY NEEDED HERE
	/// </summary>
	public const string IconKey = "PostIconModelRequest";
	...
	public PostApiMetaInfoModelRequestValidationFilter(
        IValidator<PostApiMetaInfoModelRequest> requestValidator,
