...
/// <summary>
/// The collection of Endpoints for the PropertyMetaInfo Model in API pertaining to the PUT action
/// </summary>
[ApiVersion(1.0)]
public class PutPropertyMetaInfoModelEndpoint : IEndpoints
{
    private const string ContentType = "application/json";
    private const string ModelTypeName = "PropertyMetaInfo";

    /// <summary>
    /// Register specific services need for the PropertyMetaInfo Model PUT endpoint to the DI container
    /// </summary>
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app
            .MapPut(
                PropertyMetaInfoModelEndpoints.PutEndpoint,
                PutPropertyMetaInfoModelAsync)
            .WithName(PropertyMetaInfoModelEndpoints.PutEndpointName)
            .Accepts<PutPropertyMetaInfoModelRequest>(ContentType)
            ...
            .AddEndpointFilter<PutPropertyMetaInfoModelRequestValidationFilter>();
    ...
    /// <summary>
    /// Search for and update a specific PropertyMetaInfo Model result from the database
    /// </summary>
    ...
    /// <returns>The updated copy of the PropertyMetaInfo Model</returns>
    ...
    private static async Task<IResult> PutPropertyMetaInfoModelAsync(
        HttpContext http,
        string id,
        PutPropertyMetaInfoModelRequest changes,
