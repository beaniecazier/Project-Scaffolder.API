...
/// <summary>
/// The collection of Endpoints for the ModelMetaInfo Model in API pertaining to the PUT action
/// </summary>
[ApiVersion(1.0)]
public class PutModelMetaInfoModelEndpoint : IEndpoints
{
    private const string ContentType = "application/json";
    private const string ModelTypeName = "ModelMetaInfo";

    /// <summary>
    /// Register specific services need for the ModelMetaInfo Model PUT endpoint to the DI container
    /// </summary>
    ...
    /// <summary>
    /// Map all ModelMetaInfo Model Endpoints with correct settings
    /// </summary>
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app
            .MapPut(
                ModelMetaInfoModelEndpoints.PutEndpoint,
                PutModelMetaInfoModelAsync)
            .WithName(ModelMetaInfoModelEndpoints.PutEndpointName)
            .Accepts<PutModelMetaInfoModelRequest>(ContentType)
            ...
            .AddEndpointFilter<PutModelMetaInfoModelRequestValidationFilter>();
    ...
    /// <summary>
    /// Search for and update a specific ModelMetaInfo Model result from the database
    /// </summary>
    ...
    /// <returns>The updated copy of the ModelMetaInfo Model</returns>
    ...
    private static async Task<IResult> PutModelMetaInfoModelAsync(
        HttpContext http,
        string id,
        PutModelMetaInfoModelRequest changes,
        ...
        CancellationToken token)
    {
		...
		var queryResultProperties =
			(http.Items[PutModelMetaInfoModelRequestValidationFilter.PropertiesKey] as IEnumerable<PropertyMetaInfoModel>)!
			.ToList();
        ...
        string userId)
    {
        ...
        var locationUri = linker.GetUriByName(
            httpContext: context,
            endpointName: ModelMetaInfoModelEndpoints.GetByIdEndpointName,
