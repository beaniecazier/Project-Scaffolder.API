...
/// <summary>
/// The collection of Post Endpoints for the ApiMetaInfo Model in API
/// </summary>
[ApiVersion(1.0)]
public class PostApiMetaInfoModelEndpoint : IEndpoints
{
    private const string ContentType = "application/json";
    private const string ModelTypeName = "ApiMetaInfo";

    /// <summary>
    /// Register specific services need for the ApiMetaInfo Model POST endpoint to the DI container
    /// </summary>
    ...
    /// <summary>
    /// Map all ApiMetaInfo Model POST Endpoint with correct settings
    /// </summary>
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPost(
                ApiMetaInfoModelEndpoints.PostEndpoint,
                PostApiMetaInfoModelAsync)
            .WithName(ApiMetaInfoModelEndpoints.PostEndpointName)
            .Accepts<ApiMetaInfoModel>(ContentType)
            .Produces<ApiMetaInfoModel>(StatusCodes.Status201Created)
            ...
            .AddEndpointFilter<PostApiMetaInfoModelRequestValidationFilter>();
    ...
    /// <summary>
    /// Create a new ApiMetaInfo Model
    /// </summary>
    /// <param name="http">the http context</param>
    /// <param name="request">The parameters used to make the new ApiMetaInfo Model</param>
    ...
    private static async Task<IResult> PostApiMetaInfoModelAsync(
        HttpContext http,
        PostApiMetaInfoModelRequest request,
        ...
        CancellationToken token)
    {
		...
		var queryResultModels =
			(http.Items[PostApiMetaInfoModelRequestValidationFilter.ModelsKey] as IEnumerable<ModelMetaInfoModel>)!
			.ToList();
