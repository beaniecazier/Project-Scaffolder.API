...
/// <summary>
/// The collection of Post Endpoints for the ModelMetaInfo Model in API
/// </summary>
[ApiVersion(1.0)]
public class PostModelMetaInfoModelEndpoint : IEndpoints
{
    private const string ContentType = "application/json";
    private const string ModelTypeName = "ModelMetaInfo";

    /// <summary>
    /// Register specific services need for the ModelMetaInfo Model POST endpoint to the DI container
    /// </summary>
    ...
    /// <summary>
    /// Map all ModelMetaInfo Model POST Endpoint with correct settings
    /// </summary>
    ...
    public static void DefineEndpoints(IEndpointRouteBuilder app)
    {
        ...
        var singleEndpoint = app.MapPost(
                ModelMetaInfoModelEndpoints.PostEndpoint,
                PostModelMetaInfoModelAsync)
            .WithName(ModelMetaInfoModelEndpoints.PostEndpointName)
            .Accepts<ModelMetaInfoModel>(ContentType)
            .Produces<ModelMetaInfoModel>(StatusCodes.Status201Created)
            ...
            .AddEndpointFilter<PostModelMetaInfoModelRequestValidationFilter>();
    ...
    /// <summary>
    /// Create a new ModelMetaInfo Model
    /// </summary>
    /// <param name="http">the http context</param>
    /// <param name="request">The parameters used to make the new ModelMetaInfo Model</param>
    ...
    private static async Task<IResult> PostModelMetaInfoModelAsync(
        HttpContext http,
        ...
        CancellationToken token)
    {
		...
		var queryResultProperties =
			(http.Items[PostModelMetaInfoModelRequestValidationFilter.PropertiesKey] as IEnumerable<PropertyMetaInfoModel>)!
			.ToList();
